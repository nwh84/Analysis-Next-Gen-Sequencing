...
![](/Users/noelawheeler/Desktop/Analysis of next gen seq data/read quality fastqc_1.png)

#### Quality scores for SRR8367773_2.fastq:

![](/Users/noelawheeler/Desktop/Analysis of next gen seq data/read quality fastq_2.png)
The only issue we see is with GC content.

#### GC content SRR8367773_1.fastq: 
![](/Users/noelawheeler/Desktop/Analysis of next gen seq data/gc content fastqc_1.png)

#### GC content SRR8367773_2.fastq:
![](/Users/noelawheeler/Desktop/Analysis of next gen seq data/gc content fastqc_2.png)
...
I chose for outSAMtype to be a BAM file sorted by coordinate.
I changed alignIntronMax parameter to be 2700000 because the longest intron in the human genome is 2.7 million bp long.
I changed alignIntronMin parameters to be 3. The default is 20, but I wanted to include introns smaller than 10 bp.
I changed soloStrand to be forward since the library prep is a stranded protocol where the strand that is read is only in the forward direction of the original mRNA strand.
...
![](/Users/noelawheeler/Desktop/Analysis of next gen seq data/star_alignment_plot.png)
